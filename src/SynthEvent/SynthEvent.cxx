...
SynthEventElastic::SynthEventElastic()
   : genie::EventRecord()
{
   ...
   //this->AttachSummary( new Interaction( init_state, ProcessInfo( kScCoherent, kIntWeakCC ) ) );
   this->AttachSummary( new Interaction( init_state, ProcessInfo( kScCoherentElastic, kIntWeakCC ) ) );

   this->Summary()->KinePtr()->SetQ2( 0.05, true );
