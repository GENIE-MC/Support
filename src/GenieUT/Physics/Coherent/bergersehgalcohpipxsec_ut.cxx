...
void bergersehgalcohpipxsec_ut()
{
  ...
  BergerSehgalCOHPiPXSec2015* bs = new BergerSehgalCOHPiPXSec2015();
  bs->Configure("Default" );

#ifdef PRINTOUT
  UpdateBenchmark::Instance()->Write( "namespace bergersehgalcohpipxsec {" );
#endif
...
#else
  BOOST_CHECK_EQUAL( valid,coh_xsec::bergersehgalcohpipxsec::valid );
#endif
  ...
  UpdateBenchmark::Instance()->Write( s );
#else
  BOOST_CHECK_CLOSE(xsec,coh_xsec::bergersehgalcohpipxsec::xsec,tolerance_in_percent );
#endif
   ...
   UpdateBenchmark::Instance()->Write( s );
#else
   BOOST_CHECK_CLOSE( bsintegral,  coh_xsec::bergersehgalcohpipxsec::bsintegral, tolerance_in_percent );
#endif

#ifdef PRINTOUT
   UpdateBenchmark::Instance()->Write( "} // end namespace bergersehgalcohpipxsec" );
#endif
